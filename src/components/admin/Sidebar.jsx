    ...
    return (
        <aside id="layout-menu" className={`layout-menu menu-vertical menu bg-menu-theme ${isOpen ? 'open' : ''} d-md-block`}>
            ...
            <ul className="menu-inner py-1">
                ...
                <li className={`menu-item ${isActive('/admin')}`}>
                    <Link to="/admin" className="menu-link text-decoration-none">
                        <i className="bi bi-bar-chart menu-icon"></i>
                        <span>{t('Dashboard')}</span>
                    </Link>
                </li>
                <li className={`menu-item ${isActive('/admin/categories')}`}>
                    <Link to="/admin/categories" className="menu-link text-decoration-none">
