...
export const View = () => {
    ...
    const tasks = [
        { id: 1, task_name: 'Task 1', description: 'Description 1', start_date: '2024-01-01', end_date: '2024-12-31', status: 'Active', project_id: 1 },
        { id: 2, task_name: 'Task 2', description: 'Description 2', start_date: '2024-02-01', end_date: '2024-11-30', status: 'Inactive', project_id: 2 },
    ...
    return (
        <div className="card">
            ...
            {showDeleteModal && (
                <Delete taskId={selectedTaskId} onClose={handleCloseModal} deleteTask={deleteTask} />
            )}
        </div>
    );
};
