...
export const DeleteActivity = ({ activityId, onClose }) => {
     const { t } = useTranslation();
     const handleDelete = () => {
          toast.success(t('Successfully deleting a activity!'));
          setTimeout(() => {
               onClose();
          }, 1000);
     };
               ...
               <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                         <div className="modal-header">
                              <h5 className="modal-title text-danger">{t('Delete a digital catalogue', { activityId })}</h5>
                         </div>
                         <div className="modal-body">
                              <h6>{t('Are you sure you want to delete this activity?')}</h6>
                         </div>
