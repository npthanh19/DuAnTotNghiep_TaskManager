...
export const DeleteCategories = ({ categoryId, onClose }) => {
     ...
     const handleDelete = () => {
          toast.success(t('Successfully deleting a category!'));
          setTimeout(() => {
               onClose();
          }, 1000);
     };
               ...
               <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                         <div className="modal-header">
                              <h5 className="modal-title text-danger">{t('Delete a digital catalogue', { categoryId })}</h5>
                         </div>
                         <div className="modal-body">
                              <h6>{t('Are you sure you want to delete this category?')}</h6>
                         </div>
