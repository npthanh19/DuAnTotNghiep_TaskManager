...
export const DeleteUsers = ({ userId, onClose }) => {
     const { t } = useTranslation();
     const handleDelete = () => {
          toast.success(t('Successfully deleting a user!'));
          setTimeout(() => {
               onClose();
          }, 1000);
     };
               ...
               <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                         <div className="modal-header">
                              <h5 className="modal-title text-danger">{t('Delete a digital catalogue', { userId })}</h5>
                         </div>
