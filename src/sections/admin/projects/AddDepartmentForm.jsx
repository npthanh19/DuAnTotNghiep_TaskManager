...
const AddDepartmentForm = ({ projectId, onClose, onAddSuccess, onRemoveSuccess }) => {
     ...
     const handleRemoveDepartment = async (departmentId) => {
          ...
          const result = await Swal.fire({
               title: t('Delete'),
               text: t('Are you sure you want to remove this department from the project?'),
               icon: 'warning',
          ...
          if (result.isConfirmed) {
               try {
                    // Nếu người dùng xác nhận, tiến hành xóa phòng ban khỏi dự án
                    ...
                    <div className="modal-content">
                         <div className="modal-header">
                              <h5 className="modal-title">
                                   {t('Add Departments to Project')}: {projectName}
                              </h5>
